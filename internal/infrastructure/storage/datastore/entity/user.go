...
// User is the representation of the user's datastore entity.
type User struct {
...
// FromDomain is the function that builds a datastore entity slice based on the model slice's data from domain.
