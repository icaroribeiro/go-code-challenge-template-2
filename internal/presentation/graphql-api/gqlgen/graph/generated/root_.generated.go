...
var sources = []*ast.Source{
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/auth.graphql", Input: `extend type Mutation {
	...
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/authpayload.graphql", Input: `type AuthPayload {
  token: String!
}`, BuiltIn: false},
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/credentials.graphql", Input: `input Credentials {
    username: String!
    password: String!
}`, BuiltIn: false},
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/directives.graphql", Input: `directive @useDBTrxMiddleware on FIELD_DEFINITION

directive @useAuthMiddleware on FIELD_DEFINITION
directive @useAuthRenewalMiddleware on FIELD_DEFINITION`, BuiltIn: false},
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/healthcheck.graphql", Input: `type HealthCheck {
    status: String!
}
...
extend type Query {
	...
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/infopayload.graphql", Input: `type InfoPayload {
  message: String!
}`, BuiltIn: false},
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/passwords.graphql", Input: `input Passwords {
	currentPassword: String!
	newPassword: String!
}
`, BuiltIn: false},
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/scalars.graphql", Input: `scalar UUID`, BuiltIn: false},
	{Name: "internal/presentation/graphql-api/gqlgen/graph/schema/user.graphql", Input: `type User {
    id: UUID!
    username: String!
}
