...
func (_m *Repository) Create(_a0 model.Auth) (model.Auth, error) {
	ret := _m.Called(_a0)

	var r0 model.Auth
	if rf, ok := ret.Get(0).(func(model.Auth) model.Auth); ok {
		r0 = rf(_a0)
	} else {
...
func (_m *Repository) Delete(id string) (model.Auth, error) {
	ret := _m.Called(id)
...
func (_m *Repository) GetByUserID(userID string) (model.Auth, error) {
